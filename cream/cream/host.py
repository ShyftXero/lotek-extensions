...
Mirror of scribble/host.py. Reads ``cream.deps.get_config().extras`` at call time and FAILS CLOSED (503)
when the host injected nothing. Only ``cream/api_pat.py`` uses this.
"""
...
from cream.deps import get_config
