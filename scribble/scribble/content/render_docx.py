...
# matches the default template's MONO_FONT (report_templates/build_default_docx.py), so all monospace in
# the report is one font; Word substitutes a local mono if a reader's machine lacks it (mono→mono, fine).
_MONOSPACE_FONT = "DejaVu Sans Mono"
