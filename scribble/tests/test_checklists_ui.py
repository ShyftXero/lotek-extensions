...
def test_library_page_renders(client):
    resp = client.get("/scribble/checklists")
...
def test_panel_js_served(client):
    assert client.get("/scribble/static/checklists.js").status_code == 200
    assert client.get("/scribble/static/checklists_library.js").status_code == 200
