...
Converts the HTML that ``fraction.content.render_html.render_block`` produces (the tag subset it
...
which is **not** a declared Fraction dependency (only ``docxtpl`` + ``python-docx`` are). Rather than
