...
Whoever wires up routes (the driver, or ``fraction/__init__.py``) calls::

    from fraction.report_docx_api import register as register_report_docx
...
from fraction.reporting.render_docx import make_inline_artifact_url, render_report_docx
