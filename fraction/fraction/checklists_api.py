...
Checklists are non-blocking visual reminders (plans/FRACTION_CHECKLISTS.md). This module is the
...
updates. All prose logic (markdown/JSON parse, rollup, snapshot) lives in ``fraction.checklists``.
...
def register(api_bp, bp) -> None:
    ...
    def checklists_library():
        ...
        return render_template("fraction/checklists_library.html")
